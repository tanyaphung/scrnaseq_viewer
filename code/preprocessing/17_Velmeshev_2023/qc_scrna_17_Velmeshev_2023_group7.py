# This script processes the scRNAseq data from prenatal and postnatal from Velmeshev et al. 2023 Science group_7
...
def main():
    ...
    # --------------------------------------
    # processing for group_7 (10-20 years)
    # --------------------------------------
    print("Subsetting the adata for sequencing group_7 10-20 years")
    id_group7 = "234_Velmeshev2023_PrePostNatal_Human_2023_group7"
    ...
    cell_id_group7 = metadata[(metadata["development_stage"] == "12-year-old human stagee") | (metadata["development_stage"] == "14-year-old human stage") | (metadata["development_stage"] == "19-year-old human stage") | (metadata["development_stage"] == "13-year-old human stage") | (metadata["development_stage"] == "15-year-old human stage") | (metadata["development_stage"] == "16-year-old human stage") | (metadata["development_stage"] == "10-year-old human stage") | (metadata["development_stage"] == "17-year-old human stage")]["cell_id"]
    adata.obs.set_index('index', inplace=True)
    
    adata_group7_subset = adata[cell_id_group7]
    # adata_group7_subset.X = adata_group7_subset.raw.X.copy() #copy the raw layer to X layer #not sure why this command is throwing an integer error
    ...
    print(adata_group7_subset.raw.X.A[1:10,1:10],file=log_group7)
