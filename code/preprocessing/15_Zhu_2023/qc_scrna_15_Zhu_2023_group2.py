# This script processes the scRNAseq data from neocortex from Zhu et al. 2023 group_2
...
def main():
    ...
    # --------------------------------------
    # processing for group_2
    # --------------------------------------
    print("Subsetting the adata for sequencing group_2")
    id_group2 = "248_Zhu2023_Neocortex_Human_2023_group2"
    ...
    cell_id_group2 = metadata[(metadata["age_group"] == "late fetal")]["cell_id"]
    ...
    print(adata_group2_subset.X.A[1:25,1:25],file=log_group2)
    ...
    adata_group2_subset.obs.rename(columns={"author_cell_type": "cell_type_level_2"}, inplace = True)
    ...
    level2_cts = adata_group2_subset.obs["cell_type_level_2"].dropna().unique()
    for ct in level2_cts:
        ct_data = adata_group2_subset[adata_group2_subset.obs["cell_type_level_2"] == ct, :].X
