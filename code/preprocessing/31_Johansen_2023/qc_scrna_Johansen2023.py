# This script processes the scRNAseq data from Johansen 2023
...
# There are 24 h5ad files downloaded for 24 cell types. Here I am processing for each h5ad and will combine after computing mean/specificity
# usage: python qc_scrna_Johansen2023.py OPC
def main():
# setting up #####
    id = sys.argv[1]

    base_dir = "538_Johansen_2023_Neocortex" #change here if necessary
    h5ad_path = os.path.join("Preprocessing_scRNA/data/Johansen2023", id + ".h5ad") #change here per data
