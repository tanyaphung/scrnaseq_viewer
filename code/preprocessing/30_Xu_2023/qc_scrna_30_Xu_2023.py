# This script processes the scRNAseq data from Xu 2023
...
# usage: python qc_scrna_30_Xu_2023.py 541_Xu_Human_2023_Blood Blood
...
# setting up #####
    ...
    tissue_dict = {
        ...
        "LeftCardiacAtrium": "left cardiac atrium",
        "HeartLeftVentricle": "heart left ventricle", 
        "RightCardiacAtrium": "right cardiac atrium",
        "HeartRightVentricle": "heart right ventricle",
        "ApexOfHeart": "apex of heart",
        "InterventricularSeptum": "interventricular septum",
        "Hippocampus": "hippocampal formation",
        "AscendingColon": "ascending colon",
        "Caecum": "caecum",
        "ColonicEpithelium": "colonic epithelium",
        ...
        "VermiformAppendix": "vermiform appendix",
        "CortexOfKidney": "cortex of kidney",
        "RenalMedulla": "renal medulla",
        "RenalPapilla": "renal papilla",
        "Kidney": "kidney",
        "RenalPelvis": "renal pelvis",
        "CaudateLobeOfLiver": "caudate lobe of liver",
        "Liver": "liver",
        "Lung": "lung",
        "LowerLobeOfLeftLung": "lower lobe of left lung",
        "Bronchus": "bronchus",
        "UpperLobeOfLeftLung": "upper lobe of left lung",
        "LungParenchyma": "lung parenchyma",
        "BronchopulmonaryLymphNode": "bronchopulmonary lymph node",
        "ThoracicLymphNode": "thoracic lymph node",
        "MesentericLymphNode": "mesenteric lymph node",
        "LymphNode": "lymph node",
        "IsletOfLangerhans": "islet of Langerhans",
        "Pancreas": "pancreas",
        "SkeletalMuscleOrganVertebrate": "skeletal muscle organ, vertebrate",
        "MuscleOfPelvicDiaphragm": "muscle of pelvic diaphragm",
        "RectusAbdominisMuscle": "rectus abdominis muscle",
        "MuscleOfAbdomen": "muscle of abdomen",
        "MuscleTissue": "muscle tissue",
        "Spleen": "spleen"
    }

    base_dir = "Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = os.path.join("Preprocessing_scRNA/data/Xu2023/", region + ".h5ad") #change here per data
    ...
    cell_id = metadata[(metadata["tissue"] == tissue_dict[tissue])]["index"] 
