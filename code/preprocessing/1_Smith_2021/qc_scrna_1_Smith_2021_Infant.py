# This script processes the scRNAseq data from infant neocortex from Smith et al. 2021
...
import sys
# usage: python qc_scrna_1_Smith_2021_Infant.py id tissue
...
# setting up #####
    ...
    h5ad_path = os.path.join(base_dir, id, "30b1c353-d4e1-4f34-9577-54dcc19ab4ff.h5ad") #change here per data
