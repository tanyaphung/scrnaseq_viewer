# This script processes the scRNAseq data from Rexach et al. 2024
...
# usage: python qc_scrna_24_Rexach_2024.py 494_Rexach2024_Human_2024_PrimaryVisualCortex PrimaryVisualCortex
...
def main():
    ...
    tissue_dict = {
        ...
        "BrodmannArea4": "Brodmann (1909) area 4"
    }
    
    base_dir = "Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = "2808a16d-64c5-451b-91a5-c1a2d9f270d5.h5ad" #change here per data
