# This script processes the scRNAseq data from Cao et al. 2020
...
def main():
    ...
    id = sys.argv[1] #552_Cao_Human_2020_Cerebellum_Prenatal or 553_Cao_Human_2020_Telencephalon_Prenatal
    tissue = sys.argv[2] #cerebellum or telencephalon
    
    base_dir = "Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = os.path.join("Preprocessing_scRNA/code/qc_scrna_Cao2020/", tissue + ".h5ad") 
