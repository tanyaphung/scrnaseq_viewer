# This script processes the scRNAseq data from adult NFTs (prefrontal cortex) from Otero-Garcia et al. 2022
...
# usage: python qc_scrna_OteroGarcia2022_adult_NFTs.py id /path/to/h5ad/
...
# setting up #####
    ...
    # since the adata contains both disease and normal, subset for normal only
    ...
    adata_subset.obs.rename(columns={"Cell.Types": "cell_type_level_1"}, inplace = True)
