# This script processes the scRNAseq data from Dharshini et al. 2024
...
import sys
#keep normal 
#separate out by tissue types
# usage: python qc_scrna_25_Dharshini_2024.py 497_Dharshini2024_Human_2024_BrodmannArea9 BrodmannArea9
def main():
    ...
    tissue_dict = {
        ...
        "BrodmannArea7": "Brodmann (1909) area 7",
        "BrodmannArea17": "Brodmann (1909) area 17"
    }
    
    base_dir = "Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = "535e37d4-1f8f-41f2-8a3e-dd00709e6b36.h5ad" #change here per data
    ...
    # 2025-03-13: move this here because it was failing
    ...
    cell_id = metadata[(metadata["disease"] == "normal") & (metadata["tissue"] == tissue_dict[tissue])]["cell_id"] #change here
