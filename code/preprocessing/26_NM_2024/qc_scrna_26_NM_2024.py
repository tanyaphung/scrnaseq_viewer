# This script processes the scRNAseq data from N.M. et al. 2024
...
# usage: python qc_scrna_26_NM_2024.py 500_NM2024_Human_2024_VagalNucleus VagalNucleus
def main():
    ...
    cell_id = metadata[metadata["tissue"] == tissue_dict[tissue]]["barcodekey"] #change here
    adata.obs.set_index('barcodekey', inplace=True)
    adata_subset = adata[cell_id]
    print("Subsetting adata for tissue is finished.", file=log)
