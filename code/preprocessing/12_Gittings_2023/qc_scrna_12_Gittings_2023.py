# This script processes the scRNAseq data from frontal cortex and occipital cortex from Gittings et al. 2023
...
# setting up #####
    ...
    h5ad_path = os.path.join(base_dir, id, "original.h5ad") #change here per data
    ...
    #     metadata = metadata.rename(columns = {'barcode': 'cell_id'})
    # metadata = metadata.rename(columns = {'barcode': 'cell_id'}) #use this line for 341_Gittings_FrontalCortex_Human_2023_Part1 and 342_Gittings_FrontalCortex_Human_2023_Part2
    metadata = metadata.rename(columns = {'index': 'cell_id'}) #use this line for 343_Gittings_OccipitalCortex_Human_2023_Part1 and 344_Gittings_OccipitalCortex_Human_2023_Part2
    ...
    # adata.obs.set_index('barcode', inplace=True) #use this line for 341_Gittings_FrontalCortex_Human_2023_Part1 and 342_Gittings_FrontalCortex_Human_2023_Part2
    adata.obs.set_index('index', inplace=True) #use this line for 343_Gittings_OccipitalCortex_Human_2023_Part1 and 344_Gittings_OccipitalCortex_Human_2023_Part2
    ...
    # adata_subset.obs.rename(columns={"cluster_layers": "cell_type_level_2"}, inplace = True)#use this line for 341_Gittings_FrontalCortex_Human_2023_Part1 and 342_Gittings_FrontalCortex_Human_2023_Part2
    adata_subset.obs.rename(columns={"cluster": "cell_type_level_2"}, inplace = True)#use this line for 341_Gittings_FrontalCortex_Human_2023_Part1 and 342_Gittings_FrontalCortex_Human_2023_Part2
