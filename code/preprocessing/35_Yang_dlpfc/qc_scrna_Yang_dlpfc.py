# This script processes the scRNAseq data from Yang dorsolateral prefrontal cortex
...
# setting up #####
    ...
    h5ad_path = "Preprocessing_scRNA/data/Yang_dlpfc/3ba3c27b-6817-4d85-a26c-71d7f6efb84c.h5ad"
    ...
    cell_id = metadata[(metadata["disease"] == "normal")]["index"] 
    ...
    print("### Number of female donors: ")
    print(len(adata_subset.obs[adata_subset.obs["sex"]=="female"]["donor_id"].unique()))
    print("### Number of male donors: ")
    print(len(adata_subset.obs[adata_subset.obs["sex"]=="male"]["donor_id"].unique()))
    print("### Number of all donors: ")
    print(len(adata_subset.obs["donor_id"].unique()))
