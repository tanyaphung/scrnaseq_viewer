# This script processes the scRNAseq data from Linnarsson meninx
...
# setting up #####
    ...
    tissue_dict = {
        "meninx": "meninx",
        "brainmeninx": "brain meninx",
        "forebrainmeninges": "forebrain meninges"
    }

    base_dir = "Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = "Preprocessing_scRNA/data/Linnarsson_meninx/f82c6e2b-8056-45a3-967a-fbadf057566f.h5ad"
    ...
    cell_id = metadata[(metadata["tissue"] == tissue_dict[tissue])]["CellID"] 
