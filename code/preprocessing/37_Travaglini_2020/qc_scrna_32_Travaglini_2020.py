# This script processes the scRNAseq data from Travaglini 2020
...
import sys
# usage: python qc_scrna_32_Travaglini_2020.py 539_Travaglini_2020_Blood blood
def main():
# setting up #####
    id = sys.argv[1]
    tissue = sys.argv[2]
    ...
    h5ad_path = "a874b4da-c6a8-486c-844c-71baa549c1e4.h5ad" #change here per data
    ...
    cell_id = metadata[(metadata["tissue"] == tissue)]["index"] 
