# This script processes the scRNAseq data from cerebellum from Sepp et al. 2023 Nature group_1
...
def main():
    ...
    id_group1 = "236_Sepp2023_Cerebellum_Human_2023_group1"
    ...
    cell_id_group1 = metadata_normal[(metadata_normal["author_stage"] == "CS18")]["cell_id"]
    adata_normal.obs.set_index('index', inplace=True)
    adata_group1_subset = adata_normal[cell_id_group1]
