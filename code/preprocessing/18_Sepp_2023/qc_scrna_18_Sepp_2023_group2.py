# This script processes the scRNAseq data from cerebellum from Sepp et al. 2023 Nature group_2
...
def main():
    ...
    id_group2 = "237_Sepp2023_Cerebellum_Human_2023_group2"
    ...
    cell_id_group2 = metadata_normal[(metadata_normal["author_stage"] == "CS19")]["cell_id"]
    adata_normal.obs.set_index('index', inplace=True)
    adata_group2_subset = adata_normal[cell_id_group2]
