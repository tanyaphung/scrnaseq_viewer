# This script processes the scRNAseq data from Han et al. 2020
...
def main():
    ...
    id = sys.argv[1] #550_Han_Human_2020_AdultCerebellum or 551_Han_Human_2020_FetalBrain
    tissue = sys.argv[2] #AdultCerebellum or FetalBrain
    
    base_dir = "Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = os.path.join("Preprocessing_scRNA/code/qc_scrna_Han2020/", tissue + ".h5ad") 
