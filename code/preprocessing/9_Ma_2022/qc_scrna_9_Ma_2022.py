# This script processes the scRNAseq data from adult dlPFC from Ma et al. 2022
...
# setting up #####
    ...
    h5ad_path = "2e0b82ee-5320-437e-b06e-3d2150e70395.h5ad" #change here per data
    ...
    # since the adata contains multiple species, we need to subset for humans only
    ...
    adata_subset.obs.rename(columns={"subtype": "cell_type_level_3"}, inplace = True)
