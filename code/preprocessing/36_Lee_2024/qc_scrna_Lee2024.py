# This script processes the scRNAseq data from Lee et al. 2024
...
# setting up #####
    ...
    h5ad_path = "Preprocessing_scRNA/data/Lee2024_dlpfc/RADC_Cohort_normal.h5ad"
    ...
    adata.var.index = adata.var.index.set_names(['ensemble_id_orig'])
    ...
    print(len(adata.obs[adata.obs["sex"]=="female"]["donor_id"].unique()))
    print("### Number of male donors: ")
    print(len(adata.obs[adata.obs["sex"]=="male"]["donor_id"].unique()))
    print("### Number of all donors: ")
    print(len(adata.obs["donor_id"].unique()))
